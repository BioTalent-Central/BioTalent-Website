	      ...
	      <div className="about-the-team">
	      	<h2>The Team</h2>
	      		<div className="images">
	      			<TeamMember member="Jenny" image="/images/headshot1.png"/>
					<TeamMember member="Josephine" image="/images/headshot2.png"/>
					<TeamMember member="John" image="/images/headshot3.png"/>
					<TeamMember member="Jim" image="/images/headshot4.png"/>
					<TeamMember member="Joyce" image="/images/headshot5.png"/>
		  		</div>
		  </div>
