	      ...
	      <div className="about-the-team">
	      	<h2>The Team</h2>
	      		<div className="images">
	      			<TeamMemberImage member="Mia" image="/images/headshot1.png"/>
					<TeamMemberImage member="Madison" image="/images/headshot2.png"/>
					<TeamMemberImage member="Michael" image="/images/headshot3.png"/>
					<TeamMemberImage member="Mark" image="/images/headshot4.png"/>
					<TeamMemberImage member="Maria" image="/images/headshot5.png"/>
		  		</div>
