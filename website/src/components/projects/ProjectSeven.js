...
function ProjectSeven() {
	return(
		...
		<div className="Projects">
	      ...
	      <ProjTitle projTitle="Project Seven"/>
	      ...
	      <div className="about-the-team">
	      	<h2>The Team</h2>
	      		<div className="images">
	      			<TeamMember member="Izzy" image="/images/headshot1.png"/>
					<TeamMember member="Imogen" image="/images/headshot2.png"/>
					<TeamMember member="Isaac" image="/images/headshot3.png"/>
					<TeamMember member="Iris" image="/images/headshot5.png"/>
		  		</div>
		  </div>
