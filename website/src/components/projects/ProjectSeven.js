	      ...
	      <div className="about-the-team">
	      	<h2>The Team</h2>
	      		<div className="images">
	      			<TeamMemberImage member="Izzy" image="/images/headshot1.png"/>
					<TeamMemberImage member="Imogen" image="/images/headshot2.png"/>
					<TeamMemberImage member="Isaac" image="/images/headshot3.png"/>
					<TeamMemberImage member="Iris" image="/images/headshot5.png"/>
		  		</div>
